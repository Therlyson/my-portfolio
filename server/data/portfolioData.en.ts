...
export const experiences = [
  ...
  },
  {
    ...
    title: 'Jovem Tech Program Scholar',
    sub_title: 'Pulse - Grupo Mateus',
    text: 'Intensive training program with practice in back-end (Java/Spring Boot/SQL) and web development. Building REST APIs with Spring Boot, PostgreSQL/MySQL data modeling, HTML/CSS/JavaScript interface development, and participation in agile ceremonies. Peer mentoring, sharing programming best practices and contributing to team development.',
...
export const projects = [
  {
    ...
    title: 'UFMA EAD Financial Management',
    ...
    tag: ['Web', 'Management', 'Full Stack'],
    site_url: '#',
    created_date: '2025-01-01',
    description:
      'Full Stack application for controlling per diems, travel, and real-time balance monitoring of UFMA EAD educational projects.',
  ...
  },
  {
    ...
    tag: ['AI', 'Research', 'Python'],
    site_url: '#',
    created_date: '2023-01-01',
    description:
      'Scientific research project using Python, Keras, and NumPy to classify images from the RSI-CB256 dataset with 4 distinct classes of sensors and Google Earth maps.',
    gallery: [{ image: '/images/main_photo.jpg' }],
  },
]
